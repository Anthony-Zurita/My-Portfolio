...
const SkillsItemFiller = ({ title, year }: Props) => {
  return (
    <div className="mb-[4rem] md:mb-[8rem]">
      ...
      <p className="text-slate-300 w-[80%]">
        This is a filler text for the SkillsItemFiller component. This component
        is used to fill in the space for the SkillsItemFiller component. This is
        just to fill in the space later when I put in more details.
      </p>
    </div>
  );
};

export default SkillsItemFiller;
